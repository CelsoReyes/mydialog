classdef EditPart < handle
    % SmartDlg Helper, used to generate dialog boxes while keeping code clean
    %
    % SmartDlg properties:
    %
    ...
    % SmartDlg methods:
    %
    %   SmartDlg - initialize a SmartDlg
    ...
    methods
        function obj=SmartDlg(hCaller,okevent)
            % initialize a SmartDlg

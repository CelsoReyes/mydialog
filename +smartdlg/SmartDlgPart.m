classdef SmartDlgPart < matlab.mixin.Heterogeneous
    %SMARTDLGPART base class for items added to a dialog box
    %
    % this inherits from matlab.mixin.Heterogenous to allow one to create an array.
    
    properties
        height=17 % default height for dialog box
        width=330 % default width for dialog part
        tooltip=''
        tag=''
        h
    end
